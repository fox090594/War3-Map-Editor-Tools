...
namespace War3_Map_Editor_Tools.UnitsEditor
{
    ...
    {
        public static Dictionary<int, Upgrade> List = new Dictionary<int, Upgrade>();
        ...
        {
            using (var reader = new StreamReader(path + "\\UpgradeData.slk", System.Text.Encoding.ASCII))
            {
                string line;
                Upgrade c = new Upgrade();
                bool Add = false;
