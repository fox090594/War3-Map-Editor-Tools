...
namespace War3_Map_Editor_Tools.UnitsEditor
{
    ...
    {
        public static Dictionary<int, Abilities> List = new Dictionary<int, Abilities>();
        ...
        {
            using (var reader = new StreamReader(path + "\\UnitAbilities.slk", System.Text.Encoding.ASCII))
            {
                string line;
                Abilities c = new Abilities();
                bool Add = false;
